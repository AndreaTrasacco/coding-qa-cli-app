...
public interface AnswerDAO {
    ...
    String delete(String id) throws DAOException;
    ...
    boolean vote(String id, boolean voteType, String idVoter, String owner) throws DAOException; // true: upvote, false: downvote
    String accept(String id, boolean accepted) throws DAOException; // Accepting an answer means closing the question
